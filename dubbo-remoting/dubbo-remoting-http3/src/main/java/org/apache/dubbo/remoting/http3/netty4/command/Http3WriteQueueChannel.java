...
public class Http3WriteQueueChannel extends Http2ChannelDelegate {

    private final HttpWriteQueue httpWriteQueue;

    public Http3WriteQueueChannel(H2StreamChannel h2StreamChannel, HttpWriteQueue httpWriteQueue) {
