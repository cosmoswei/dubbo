...
public class NettyHttp3FrameHandler extends ChannelDuplexHandler {
    ...
    public NettyHttp3FrameHandler(QuicStreamChannel quicStreamChannel, Http3TransportListener transportListener) {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        if (msg instanceof Http3HeadersFrame) {
            transportListener.onMetadata((Http3HeadersFrame) msg);
        } else if (msg instanceof Http3DataFrame) {
            transportListener.onData((Http3DataFrame) msg);
        } else {
    ...
    public void exceptionCaught(ChannelHandlerContext ctx, Throwable cause) throws Exception {
        ...
        quicStreamChannel.shutdown(statusCode);
    }
}
