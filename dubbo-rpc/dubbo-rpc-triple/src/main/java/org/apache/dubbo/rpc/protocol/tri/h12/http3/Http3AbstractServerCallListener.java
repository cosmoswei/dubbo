...
public abstract class Http3AbstractServerCallListener implements ServerCallListener {

    private static final ErrorTypeAwareLogger LOGGER =
            LoggerFactory.getErrorTypeAwareLogger(Http3AbstractServerCallListener.class);
    ...
    public Http3AbstractServerCallListener(
