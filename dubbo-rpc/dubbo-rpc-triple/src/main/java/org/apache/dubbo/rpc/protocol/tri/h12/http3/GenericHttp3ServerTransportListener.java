...
public class GenericHttp3ServerTransportListener extends AbstractServerTransportListener<Http2Header, Http2InputMessage>
    ...
    public GenericHttp3ServerTransportListener(
        ...
        serverChannelObserver = new Http3ServerCallToObserverAdapter(frameworkModel, h2StreamChannel);
